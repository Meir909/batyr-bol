...
const DIFFICULTY_LEVELS = {
    1: {
        ...
        age: '7-10 жас',
        age_ru: '7-10 лет',
        description_kz: 'Қысқа мәтіндер, көп көмек',
        description_ru: 'Короткие тексты, много подсказок',
        icon: '🌱',
        textLength: 'short',      // 3-4 сөйлем
        optionsCount: 2,          // 2 вариант
        questionsCount: 3,        // 3 сұрақ
    ...
    4: {
        name_kz: 'ЕНТ дайындық',
        name_ru: 'Подготовка к ЕНТ',
        age: '17+ жас',
        age_ru: '17+ лет',
        description_kz: 'ЕНТ форматы, көмексіз',
        description_ru: 'Формат ЕНТ, без подсказок',
        icon: '🎯',
        textLength: 'ent',        // 10+ сөйлем, детальды
        optionsCount: 4,          // 4 вариант (ЕНТ формат)
        questionsCount: 5,        // 5 сұрақ
        showHints: false,         // Көмек жоқ
        energyBonus: 0,           // Бонус жоқ
